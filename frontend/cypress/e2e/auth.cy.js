describe("Auth Component Tests", () => {
  ...
  describe('Page Layout', () => {
    it('should display signin and signup cards', () => {
      ...
      cy.contains('Sign up | Create New Account').should('be.visible')
    })
  ...
  describe('Button Styling', () => {
    it('should have correct button colors', () => {
      cy.get('.col-5 .q-btn').should('have.class', 'bg-primary')   // color="primary"
      cy.get('.col-7 .q-btn').should('have.class', 'bg-positive')  // color="positive"
    })
  })
  ...
  describe('Form Interactions', () => {
    ...
    it('should show next required error after filling previous fields (signup)', () => {
      ...
      cy.get('.col-7 input').eq(2).type('j@example.com')
      cy.get('.col-7 button[type="submit"]').click()
